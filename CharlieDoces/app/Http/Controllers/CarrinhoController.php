...
class CarrinhoController extends Controller
{
    public function addCarrinho(Request $request)
    {
        ...
        if (!$estoque) {
            return response()->json(['message' => 'Estoque n�o encontrado para este produto.'], 404);
        }
        ...
        if ($estoqueQtd < $quantidade) {
            return response()->json(['message' => 'Quantidade solicitada indispon�vel no estoque.'], 400);
        }
        ...
        // Obt�m a quantidade total de itens no carrinho
    ...
    // M�todo para atualizar a quantidade de um item no carrinho
