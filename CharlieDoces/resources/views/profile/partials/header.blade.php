        ...
        <nav>
            ...
            <div class="nav-section">
                ...
                <a href="{{ Auth::check() ? url('/carrinho') : url('/login') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(89, 31, 18, 1);">
                        <path d="M21.822 7.431A1 1 0 0 0 21 7H7.333L6.179 4.23A1.994 1.994 0 0 0 4.333 3H2v2h2.333l4.744 11.385A1 1 0 0 0 10 17h8c.417 0 .79-.259.937-.648l3-8c.113-.302.06-.646-.135-.896zM9.248 15l-3.1-7.922.819-2.057h7.658l.857 2.057-3.099 7.922H9.248z"></path>
                    </svg>
                    Carrinho
                </a>
            </div>
